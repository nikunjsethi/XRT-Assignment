...
Shader "NOT_Lonely/NOT_MaskedPBR"
{
	Properties
	{
		...
		[ASEBegin]_MainTex("Albedo (RGB)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = tex2DNode17.rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = ( tex2DNode17.a - (0.0 + (_Dirt - 0.0) * (0.1 - 0.0) / (5.0 - 0.0)) );
				surfaceDescription.Occlusion = tex2D( _Occlusion, uv_Occlusion ).g;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_Occlusion = packedInput.ase_texcoord.xy * _Occlusion_ST.xy + _Occlusion_ST.zw;
...
/*ASEBEGIN
Version=18912
308;605;1920;951;2003.366;585.9298;1.474885;True;False
Node;AmplifyShaderEditor.SamplerNode;1;-1628.422,-75.58686;Inherit;True;Property;_MainTex;Albedo (RGB);0;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;19;-1679.843,-222.0275;Float;False;Property;_Dirt;Dirt;9;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;33;-1315.955,-101.6223;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;6;-1203.199,92.40023;Float;False;Property;_Color01;Color01;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;12;-885.696,-485.5997;Inherit;True;Property;_ColorMask;Color Mask;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;22;5;17;0
WireConnection;22;7;21;0
WireConnection;22;8;15;2
ASEEND*/
//CHKSM=2766D9AB32734B3BC103F0D9CD85A18C942DDD1D